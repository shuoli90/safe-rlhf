...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog='deepspeed --module safe_rlhf.algorithms.cpg',
        description='Train language model using Constrained Policy Gradient algorithm.',
    ...
    generation_parser.add_argument(
        ...
        type=int,
        default=4,
        help='The number of independently computed returned sequences for each element in the lambda batch.',
    )
    generation_parser.add_argument(
        '--rl_num_return_sequences',
        type=int,
        default=1,
        help='The number of independently computed returned sequences for each element in the rl batch.',
    )
    generation_parser.add_argument(
        '--repetition_penalty',
        type=float,
...
def main() -> None:
    ...
    trainer = CPGTrainer(args, ds_train_config, ds_eval_config)
    trainer.train()
    trainer.save()
